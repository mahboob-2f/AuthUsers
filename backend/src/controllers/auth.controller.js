...
You can now securely access your account and start using our services.

If you did not create this account, please contact our support team immediately.

Thank you for choosing AuthUser.
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
  <h2 style="color: #2c3e50;">Welcome to AuthUser</h2>

  <p>Hello,</p>

  <p>
    Thank you for registering with <strong>AuthUser</strong>.
    Your account has been successfully created using the email address:
  </p>
  ...
  <p>
    You can now log in and start using our platform securely.
  </p>
...
export const logIn = async (req, res) => {
    try {
        ...
        const mailOptions = {
            from: process.env.SENDER_EMAIL,
            to: email,
            subject: "Security Alert: New Login to Your AuthUser Account",
            text: `
Hello,

We noticed a successful login to your AuthUser account.
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
  ...
  <p>We noticed a successful login to your <strong>AuthUser</strong> account.</p>
  ...
  <p>
    Best regards,<br>
    <strong>AuthUser Security Team</strong>
  </p>
